...
const Company = () => {
  ...
  useEffect(() => {
    try {
      ...
      const options = {
        method: 'GET',
        url: `${process.env.REACT_APP_NODE_ENDPOINT}/api/profile`,
    ...
    return (
      <section className="fade-in">
        <div className="flex flex-col font-custom font-semibold text-center text-md pd-3 mb-10 text-white">
          ...
          <div>
            <img className="sm:w-24 md:w-24 lg:w-32 xl:w-32 m-auto mt-5" src={stockData['image']} alt={stockData['symbol']} 
          ...
          <div className="flex justify-center gap-6 sm:mt-6 md:mt-8 xl:mt-12">
            <div className="flex flex-col sm:w-24 md:w-40 lg:w-40 xl:w-60">
              ...
              <div className="sm:text-xl md:text-3xl lg:text-3xl xl:text-4xl text-pink-100">
          ...
          <div className="flex flex-col m-auto mt-10">
            ...
            <div className="font-normal text-left px-4 sm:text-lg md:text-lg lg:text-2xl xl:text-2xl text-pink-100 max-w-4xl">
